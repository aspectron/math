#pragma once
#ifndef __MATH_EULER_ANGLES_HPP__
#define __MATH_EULER_ANGLES_HPP__
...
class euler_angles    // (x,y,z)=ang 1,2,3, w=order code 
{
	...
	#undef MAKE_ORDER
		...
		euler_angles() {}
		euler_angles(const euler_angles& a) { ::memcpy(this, &a, sizeof(euler_angles)); }
		...
		double get_angle(const int a) const { return v[a]; }

//		double& operator[] (int i) { return m[i]; }
		void set(int iAxis, double f) { v[iAxis] = f; }
};
...
#endif // __MATH_EULER_ANGLES_HPP__